...
class EcaHosFormController extends Controller
{
    public function formIndex(int $subjectTeacherId)
    {
        try {
            ...
            return view('hos.dashboard.ecaForm', compact('subjectTeacher', 'terms', "casTypes", "students", "studentExams", "examFullMarks","subject"));
