...
class ClubAssignmentController extends Controller
{
    public function edit(int $assignmentId)
    {
        try {
            ...
            $assignment = ClubAssignment::where('id', $assignmentId)->whereHas('subjectTeacher.subject.grade.school', function ($query) use ($teacherId) {
            ...
            return view("hos.clubAssignments.edit", compact('assignment', 'casTypes', 'cas'));
        } catch (Exception $e) {
