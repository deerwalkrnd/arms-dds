...
class ClubHosFormController extends Controller
{
    public function formIndex(int $subjectTeacherId)
    {
        try {
            ...
            return view('hos.dashboard.clubForm', compact('subjectTeacher', 'terms', "casTypes", "students", "studentExams", "examFullMarks","subject"));
