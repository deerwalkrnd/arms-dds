...
class ReadingTeacherFormController extends Controller
{
    public function readingFormIndex(int $subjectTeacherId)
    {
        try {
            $teacherId = auth()->id();
            ...
            return view('teacher.dashboard.readingForm', compact('subjectTeacher', 'terms', "casTypes", "students", "studentExams", "examFullMarks", "subject"));
    ...
    public function storeExam(int $subjectTeacherId, ReadingTeacherCasStoreRequest $request)
    {
