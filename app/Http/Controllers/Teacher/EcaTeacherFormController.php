...
class EcaTeacherFormController extends Controller
{
    public function ecaFormIndex(int $subjectTeacherId)
    {
        try {
            $teacherId = auth()->id();
            ...
            return view('teacher.dashboard.ecaForm', compact('subjectTeacher', 'terms', "casTypes", "students", "studentExams", "examFullMarks", "subject"));
    ...
    public function storeExam(int $subjectTeacherId, EcaTeacherCasStoreRequest $request)
    {
    ...
    public function storeCas(int $subjectTeacherId, EcaTeacherCasStoreRequest $request)
    {
        ...
        try {
            ...
            $assignment = EcaAssignment::create([
            ...
            foreach ($data["students"] as $id => $student) {
                ...
                EcaCas::create([
                    ...
                    "ecaAssignment_id" => $assignment->id,
                    "mark" => $data["marks"][$id],
                    "remarks" => ""
                ]);
            }
    ...
    public function saveCas(int $subjectTeacherId, EcaTeacherCasStoreRequest $request)
    {
