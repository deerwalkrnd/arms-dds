...
class SubjectTeacherController extends Controller
{
    ...
    public function store(SubjectTeacherRequest $request)
    {
        ...
        try {
            $sectionsId= $data["section_id"];
            foreach($sectionsId as $sectionId){
                $subjectTeacherExists = SubjectTeacher::where("subject_id", $data["subject_id"])->where("section_id", $sectionId)->where("teacher_id", $data["teacher_id"])->exists();
