...
class DeleteMarksheets extends Command
{
     ...
     * @var string
     */
    protected $description = 'Delete Marksheets after 10 days of result';
    ...
    {
        $currentTerms = Term::whereDate('result_date', Carbon::now()->subDays(10))
    ...
    {
        $directoryPath = storage_path('app/results/Grade ' . $term->grade->name." ".$term->name);
        $zipFilePath = storage_path('app/results/Grade ' . $term->grade->name . " " . $term->name. '.zip');
