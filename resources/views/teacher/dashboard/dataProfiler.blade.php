...
@section('content')
    ...
    <div class="flex flex-col w-full p-8 gap-10">
        ...
        <div
                class="assignmentGraphContainer flex gap-4 w-full flex-wrap justify-center px-4 py-6 border border-black rounded-md">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#studentSelect").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('teacherData.getTermsForStudent') }}",
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('teacherData.getStudentData') }}",
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('teacherData.getStudentAverageAssignmentMarksByCasTypeForEachSubject') }}",
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('teacherData.getExamMarksForEachTerm') }}",
        ...
        $("#termSelector").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('teacherData.filterTermForStudentAssignmentData') }}",
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('teacherData.filterStudentAverageAssignmentMarksByCasTypeForEachSubjectByTerm') }}",
