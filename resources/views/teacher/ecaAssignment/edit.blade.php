...
@section('script')
    <script>
        $("#saveForm").click(function() {
            $("#form").attr("action", "{{ route('teacherEcaAssignments.updateAndSave', (int) $assignment->id) }}")
        })
        ...
        $("#saveAndSubmitForm").click(function(e) {
            e.preventDefault();
            $("#form").attr("action", "{{ route('teacherEcaAssignments.updateAndStore', (int) $assignment->id) }}");
