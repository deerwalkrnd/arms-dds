...
@section("script")
    <script>
         ...
         $("#saveForm").click(function() {
            $("#form").attr("action", "{{ route('adminClubAssignments.updateAndSave', (int) $assignment->id) }}");
            $("#form").submit();
        })
        ...
        $("#saveAndSubmitForm").click(function() {
            $("#form").attr("action", "{{ route('adminClubAssignments.updateAndStore', (int) $assignment->id) }}");
            $("#form").submit();
        })
    </script>
@endsection