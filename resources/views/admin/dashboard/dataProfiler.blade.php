    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#studentSelect").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('adminData.getTermsForStudent') }}",
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('adminData.getStudentData') }}",
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('adminData.getStudentAverageAssignmentMarksByCasTypeForEachSubject') }}",
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('adminData.getExamMarksForEachTerm') }}",
        ...
        $("#termSelector").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('adminData.filterTermForStudentAssignmentData') }}",
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('adminData.filterStudentAverageAssignmentMarksByCasTypeForEachSubjectByTerm') }}",
