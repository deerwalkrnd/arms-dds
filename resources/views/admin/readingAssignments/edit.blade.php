...
@section("script")
    <script>
         ...
         $("#saveForm").click(function() {
            $("#form").attr("action", "{{ route('adminReadingAssignments.updateAndSave', (int) $assignment->id) }}");
            $("#form").submit();
        })
        ...
        $("#saveAndSubmitForm").click(function() {
            $("#form").attr("action", "{{ route('adminReadingAssignments.updateAndStore', (int) $assignment->id) }}");
            $("#form").submit();
        })
    </script>
@endsection