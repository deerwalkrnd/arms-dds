...
<div name="markType" class="bg-dark-orange text-white px-3 py-3 h-fit rounded-md markType text-base font-normal">
    <p value="cas" class="px-2 text-white">CAS</p>
        ...
        <div class="mt-5">
            ...
            <table class="table-auto w-full" id="casTable">
                ...
                <tbody>
                    ...
                    {{-- @if($student->subject->contains($subject->id)) --}}
...
<script>
    $('.markType').change(
        ...
        $("#saveForm").click(function() {
            $("#form").attr("action", "{{ route('hosReadingForms.saveCas', (int) $subjectTeacher->id) }}");
            $("#form").submit();
        })
        ...
        $("#saveAndSubmitForm").click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $("#form").attr("action",
                        "{{  route('hosReadingForms.storeCas', (int) $subjectTeacher->id) }}");
                    $("#form").submit();
                }
            });
        })
