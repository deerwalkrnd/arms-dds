...
@section("script")
    <script>
         ...
         $("#saveForm").click(function() {
            $("#form").attr("action", "{{ route('hosReadingAssignments.updateAndSave', (int) $assignment->id) }}");
            $("#form").submit();
        })
        ...
        $("#saveAndSubmitForm").click(function() {
            $("#form").attr("action", "{{ route('hosReadingAssignments.updateAndStore', (int) $assignment->id) }}");
            $("#form").submit();
        })
    </script>
@endsection