...
<script>
    $(document).ready(function() {
        ...
        $('#sectionSelectEdit').select2({
            width: 'auto',
        });
        $('#termId').select2({
            width: 'auto',
        });
        $('#termIdAssignmentCount').select2({
            width: 'auto',
        });
        $('#termIdAssignmentAverage').select2({
            width: 'auto',
        });
        $('#termIdExamAverage').select2({
            width: 'auto',
        });
        $('#termIdOverallAverage').select2({
            width: 'auto',
        });
    });
</script>
